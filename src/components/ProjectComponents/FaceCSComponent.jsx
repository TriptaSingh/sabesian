...
import FaceCS from '../../images/Faceclassify.jpg';
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="portfolio_right_text">
                <h4>{data.FCS}</h4>
                <p>
                  {data.FCST1}<sup><font color="#777777">{data.th}</font></sup>
                  {data.FCST2}
                </p>
                <ul className="list">
                  <li><span>{data.Year}</span>{data.numYR19}</li>
                  <li>
                    <span><h5>{data.ToolsUsed}</h5></span>
                  </li>
                  <li><span>{data.Software}</span>: Android Studio</li>
                  <li>
                  ...
                  <div className="social_widget">
                    <ul className="list">
                      ...
                      <li>
                        <figure>
                          <a href={Software_Requirements_Specification} target="_blank">
                            <img
                              className="img-fluid"
                              src={pdf}
                              alt="ppt"
                      ...
                      <li>
                        <figure>
                          <a href={Software_Architecture_Document} target="_blank">
                            <img
                              className="img-fluid"
                              src={pdf}
                              alt="ppt"
