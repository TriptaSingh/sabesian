            ...
            <div className="container">
                <div className="portfolio_details_inner">
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="portfolio_right_text">
                                ...
                                <ul className="list">
                                    <li><span>{data.Year}</span>: {data.numYR18}</li>
                                    <li>
                                        <span><h5>{data.ToolsUsed}</h5></span>
                                    </li>
                                    <li>
                                        <span>{data.Software}</span>{data.SpellMe2}
                  </li>
                                    <li><span>{data.Environment}</span>{data.SpellMe3}</li>
                                    <li>
                    ...
                    <p className="alignText">
                       {data.SpellMe4}<font color="#222222">{data.DialogGameHunt} </font>{data.SpellMe5}
          </p>
                    <p className="alignText">
                        {data.SpellMe6}<br />{data.SpellMe7}
          </p>
                </div>
            </div>
        </section>
