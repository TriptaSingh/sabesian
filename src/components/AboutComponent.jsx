        ...
        <div>
            ...
            <section className="testimonials_area testi_two p_120">
                <div className="container">
                    ...
                    <Link to="./Docs/CV_Sabesan_Sathananthan.pdf" target="_blank" className="genric-btn success circle arrow">{data.DownloadCV}<i className="fa fa-download" > </i></Link>
                    <Link to="./Docs/Resume_Sabesan_Sathananthan.pdf" target="_blank" className="genric-btn success circle arrow">{data.DownloadRésumé}<i className="fa fa-download" > </i></Link>
                    <Link to="CommingSoon/index.html" target="_blank" className="genric-btn success circle arrow">{data.ViewOnlineCV}<i className="fa fa-eye" > </i></Link>
                    </div>
                </div>
            </section>
        </div>
